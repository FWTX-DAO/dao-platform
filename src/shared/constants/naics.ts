...
export const NAICS_CODES: NaicsCode[] = [
  ...
  {
    code: "324",
    label: "Petroleum & Coal Products Manufacturing",
    sector: "Manufacturing",
    texasFocus: true,
  },
  {
    code: "213",
    label: "Support Activities for Mining & Oil/Gas",
    sector: "Mining & Oil/Gas",
    texasFocus: true,
  },
  {
  ...
  {
    code: "112",
    label: "Animal Production & Aquaculture",
    sector: "Agriculture",
    texasFocus: true,
  },
  {
    code: "522",
    label: "Credit Intermediation & Related Activities",
    sector: "Finance",
    texasFocus: true,
  },
  {
  ...
  {
    code: "516",
    label: "Computing Infrastructure & Data Processing",
    sector: "Information",
    texasFocus: true,
  },
  {
  ...
  {
    code: "115",
    label: "Support Activities for Agriculture & Forestry",
    sector: "Agriculture",
  },
  ...
  {
    code: "312",
    label: "Beverage & Tobacco Product Manufacturing",
    sector: "Manufacturing",
  },
  ...
  {
    code: "316",
    label: "Leather & Allied Product Manufacturing",
    sector: "Manufacturing",
  },
  ...
  {
    code: "323",
    label: "Printing & Related Support Activities",
    sector: "Manufacturing",
  },
  { code: "325", label: "Chemical Manufacturing", sector: "Manufacturing" },
  {
    code: "326",
    label: "Plastics & Rubber Products Manufacturing",
    sector: "Manufacturing",
  },
  {
    code: "327",
  ...
  {
    code: "335",
    label: "Electrical Equipment & Component Manufacturing",
    sector: "Manufacturing",
  },
  {
    code: "337",
    label: "Furniture & Related Product Manufacturing",
    sector: "Manufacturing",
  },
  {
    code: "339",
  ...
  {
    code: "425",
    label: "Wholesale Trade Agents & Brokers",
    sector: "Wholesale Trade",
  },
  ...
  {
    code: "442",
    label: "Furniture & Home Furnishings Retailers",
    sector: "Retail Trade",
  },
  {
    code: "443",
    label: "Electronics & Appliance Retailers",
    sector: "Retail Trade",
  },
  {
    code: "444",
    label: "Building Material & Garden Equipment Retailers",
    sector: "Retail Trade",
  },
  { code: "445", label: "Food & Beverage Retailers", sector: "Retail Trade" },
  {
    code: "446",
    label: "Health & Personal Care Retailers",
    sector: "Retail Trade",
  },
  {
    code: "447",
    label: "Gasoline Stations & Fuel Dealers",
    sector: "Retail Trade",
  },
  {
    code: "448",
    label: "Clothing & Accessories Retailers",
    sector: "Retail Trade",
  },
  {
    code: "449",
    label: "Sporting Goods, Hobby & Musical Retailers",
    sector: "Retail Trade",
  },
  {
    code: "452",
  ...
  {
    code: "454",
    label: "Nonstore Retailers (e-commerce)",
    sector: "Retail Trade",
  },
  ...
  {
    code: "485",
    label: "Transit & Ground Passenger Transportation",
    sector: "Transportation",
  },
  { code: "486", label: "Pipeline Transportation", sector: "Transportation" },
  {
    code: "487",
    label: "Scenic & Sightseeing Transportation",
    sector: "Transportation",
  },
  {
    code: "488",
  ...
  {
    code: "513",
    label: "Broadcasting & Content Providers",
    sector: "Information",
  },
  { code: "517", label: "Telecommunications", sector: "Information" },
  {
    code: "519",
    label: "Web Search Portals, Libraries & Archives",
    sector: "Information",
  },
  ...
  {
    code: "523",
    label: "Securities, Commodities & Financial Investments",
    sector: "Finance",
  },
  {
    code: "525",
    label: "Funds, Trusts & Other Financial Vehicles",
    sector: "Finance",
  },
  ...
  {
    code: "562",
    label: "Waste Management & Remediation Services",
    sector: "Administrative",
  },
  ...
  {
    code: "623",
    label: "Nursing & Residential Care Facilities",
    sector: "Health Care",
  },
  ...
  {
    code: "711",
    label: "Performing Arts, Spectator Sports & Related",
    sector: "Arts & Entertainment",
  },
  {
    code: "712",
    label: "Museums, Historical Sites & Similar",
    sector: "Arts & Entertainment",
  },
  {
    code: "713",
    label: "Amusement, Gambling & Recreation",
    sector: "Arts & Entertainment",
  },
  ...
  {
    code: "722",
    label: "Food Services & Drinking Places",
    sector: "Hospitality",
  },
  ...
  {
    code: "812",
    label: "Personal & Laundry Services",
    sector: "Other Services",
  },
  {
    code: "813",
    label: "Religious, Civic & Professional Organizations",
    sector: "Other Services",
  },
  ...
  {
    code: "925",
    label: "Housing, Urban Planning & Community Development",
    sector: "Public Administration",
  },
  {
    code: "926",
