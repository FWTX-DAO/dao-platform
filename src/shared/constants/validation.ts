...
export const AVAILABILITY_OPTIONS = ['full-time', 'part-time', 'volunteer', 'occasional'] as const;

// RBAC
export const ROLE_NAMES = ['admin', 'moderator', 'member', 'guest'] as const;
export const ROLE_LEVELS = { guest: 0, member: 10, moderator: 50, admin: 100 } as const;
export const RBAC_RESOURCES = ['forum', 'projects', 'bounties', 'members', 'documents', 'meetings', 'admin'] as const;
