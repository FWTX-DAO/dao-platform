export const queryKeys = {
  ...
  forum: {
    ...
    replies: (postId: string) =>
      [...queryKeys.forum.all(), "replies", postId] as const,
  },
  projects: {
  ...
  bounties: {
    ...
    list: (filters?: unknown) =>
      [...queryKeys.bounties.all(), "list", filters] as const,
    ...
    comments: (bountyId: string) =>
      [...queryKeys.bounties.detail(bountyId), "comments"] as const,
  },
  documents: {
    ...
    audit: (id: string) =>
      [...queryKeys.documents.detail(id), "audit"] as const,
    shares: (id: string) =>
      [...queryKeys.documents.detail(id), "shares"] as const,
  },
  meetingNotes: {
  ...
  activities: {
    ...
    member: (id: string) =>
      [...queryKeys.activities.all(), "member", id] as const,
  },
  roles: {
    all: () => ["roles"] as const,
    ...
    memberRoles: (memberId: string) =>
      [...queryKeys.roles.all(), "member", memberId] as const,
  },
  dashboard: {
    all: () => ["dashboard"] as const,
    stats: () => [...queryKeys.dashboard.all(), "stats"] as const,
    membership: () => [...queryKeys.dashboard.all(), "membership"] as const,
  },
  stamps: {
    all: () => ["stamps"] as const,
