...
export const subscriptions = pgTable(
  ...
  (table) => [
    ...
    index("idx_subscriptions_stripe_subscription_id").on(
      table.stripeSubscriptionId,
    ),
    index("idx_subscriptions_status").on(table.status),
    index("idx_subscriptions_customer_status").on(
...
export const memberActivities = pgTable(
  ...
  (table) => [
    ...
    index("idx_member_activities_member_type").on(
      table.memberId,
      table.activityType,
    ),
    index("idx_member_activities_member_created").on(
      table.memberId,
      table.createdAt,
    ),
    index("idx_member_activities_resource").on(
      table.resourceType,
      table.resourceId,
    ),
  ],
...
export const innovationBounties = pgTable(
  "innovation_bounties",
  {
    id: text("id").primaryKey(),
  ...
  (table) => [
    ...
    index("idx_innovation_bounties_submission_source").on(
...
export const passportStamps = pgTable(
  ...
  (table) => [
    ...
    index("idx_passport_stamps_member_created").on(
      table.memberId,
      table.createdAt,
    ),
  ],
...
export const documentAuditTrailRelations = relations(
  documentAuditTrail,
  ({ one }) => ({
...
export const innovationBountiesRelations = relations(
  innovationBounties,
  ({ one, many }) => ({
    submitter: one(users, {
...
export const bountyProposalsRelations = relations(
  bountyProposals,
  ({ one }) => ({
...
export const bountyCommentsRelations = relations(
  bountyComments,
  ({ one, many }) => ({
    bounty: one(innovationBounties, {
...
export const memberActivitiesRelations = relations(
  memberActivities,
  ({ one }) => ({
    member: one(members, {
