...
async function seed() {
  ...
  try {
      ...
      .values([
        {
          ...
          content:
            "This is our community forum where we discuss ideas, proposals, and collaborate on making Fort Worth a leader in Web3 civic innovation. Feel free to introduce yourself and share your ideas!",
          category: "General",
          parentId: null,
        },
        {
          ...
          content:
            "I propose we develop a transparent, secure voting system using blockchain technology for Fort Worth municipal elections. This would increase voter confidence and participation while ensuring tamper-proof results.",
          category: "Governance",
          parentId: null,
        },
        {
          ...
          content:
            "Join us for a hands-on workshop on smart contract development using Solidity. We'll cover the basics and build a simple DAO contract together.",
          category: "Education",
          parentId: null,
        },
      ])
      ...
      .values([
        {
          ...
          description:
            "A decentralized platform for community-driven public transit improvements",
          githubRepo: "https://github.com/fwtx-dao/transit-dao",
          intent: "Improve public transportation through community governance",
          benefitToFortWorth:
            "Creates transparent, community-driven decision making for transit routes and schedules, potentially reducing commute times by 20%",
          status: "active",
        ...
        },
        {
          ...
          benefitToFortWorth:
            "Increases civic engagement by gamifying participation in town halls, voting, and community service",
          status: "proposed",
    ...
    const sampleMeetingNotes = await db
      .insert(meetingNotes)
      .values([
        {
          id: generateId(),
          ...
          notes:
            "Discussed expanding the DAO's reach through educational workshops. Budget allocated for 3 major initiatives. Strong community interest in blockchain governance solutions.",
          actionItems:
            "Schedule blockchain workshop for February\nCreate project submission guidelines\nSet up community treasury wallet",
        ...
        },
        {
          ...
          notes:
            "Decided to implement Turso for database needs due to edge deployment capabilities. Security audit scheduled for next month. Drizzle ORM chosen for type safety.",
          actionItems:
