...
export default function GlobalError({
  ...
  return (
    <main
      className="min-h-screen bg-dao-charcoal flex flex-col items-center justify-center px-6"
      role="alert"
    >
      <h1 className="font-display text-4xl text-dao-warm mb-4">
        Something went wrong
      </h1>
      <p className="text-dao-cool text-base mb-8">
