  ...
  return (
    <main className="relative min-h-screen bg-dao-charcoal overflow-hidden selection:bg-dao-gold/30 selection:text-dao-warm">
      ...
      <div className="relative z-20 flex flex-col min-h-screen">
        ...
        <header
          role="banner"
          className="flex items-center justify-between px-6 md:px-12 lg:px-16 py-4 md:py-5"
        >
          <Link
            href="/"
        ...
        <div
          id="hero-content"
          className="flex-1 flex flex-col justify-center px-6 md:px-12 lg:px-16 py-12"
        >
          <div className="max-w-5xl">
            ...
            >
              <h1 className="font-display text-[2.75rem] sm:text-6xl md:text-7xl lg:text-[5.5rem] xl:text-[6.5rem] text-dao-warm leading-none tracking-[-0.01em]">
                Digital Sovereignty
                <br />
                <span className="text-dao-gold italic">
                  is Mission Critical.
                </span>
              </h1>
            </div>
            ...
            >
              <p className="text-dao-cool text-base md:text-lg lg:text-xl max-w-xl leading-relaxed">
                Fort Worth DAO — advancing decentralized governance, cyber
                workforce development, digital sovereignty, AI accelerationism,
                and civic innovation lab for our City&apos;s future.
              </p>
            </div>
        ...
        <footer
          role="contentinfo"
          className="px-6 md:px-12 lg:px-16 pb-6 md:pb-8"
        >
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2 border-t border-dao-warm/6 pt-5">
            ...
            <p className="text-[11px] text-dao-cool/20 tracking-[0.15em] uppercase">
              fwtx.city
            </p>
          </div>
        </footer>
