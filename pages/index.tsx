...
export default function LoginPage() {
  ...
  return (
    <>
      <Head>
        <title>Fort Worth TX DAO — Digital Sovereignty is Mission Critical</title>
      </Head>
            ...
            <div className="max-w-5xl">
              ...
              >
                <p className="text-dao-cool text-base md:text-lg lg:text-xl max-w-xl leading-relaxed">
                  Fort Worth&apos;s civic innovation laboratory — advancing
                  cryptographic governance, digital property rights, and AI
                  literacy for our city&apos;s future.
                </p>
              </div>
